...
SECRET_KEY = 'django-insecure-xxxxxxxxxxxxxxxxxxxx'  # Keep your existing key
...
WSGI_APPLICATION = 'core.wsgi.application'  # Make sure this matches your project name
...
SECURE_CONTENT_TYPE_NOSNIFF = False  # For SVG support
